...
export default function SearchHeader({
  ...
  const placeholders = {
    ...
    issues: "Find issues...",
    contributors: "Find contributors...",
    none: "",
  };
  const handleGitHub = () => {
  ...
  return (
    <header className="flex items-center h-[70px] justify-between sticky top-0 z-40 px-2 gap-1 md:px-8 border-b border-border bg-background">
      <button
        ...
        className="justify-center text-sm font-medium transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 border bg-transparent hover:bg-accent hover:text-accent-foreground rounded-full size-8 items-center relative flex md:hidden"
      >
